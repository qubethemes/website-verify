                        ...
                        <div class="row">
                           ...
                           $this->settings->output();
                            ...
                            <div class="column p1">
                                ...
                                <div class="instruction">
                                    ...
                                    <p> 1. Copy the code from the content attribute,as shown in example:<br/>
                                        ...
                                        /&gt;.
                                    <p>2. Add your site verification code and in respective meta tag and save the
                                        changes.</p>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[google_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[google_verify]'
                                           ); ?>" aria-describedby="googleVerify"
                                           value="<?php echo (!empty($options['google_verify'])) ? esc_html($options['google_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="googleVerify" class="form-text text-muted">If you havent registered for
                                        Google Webmaster Verification Console, Go to <a
                                                href="https://search.google.com/search-console/ownership">Signup
                                            here</a></small>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[bing_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[bing_verify]'
                                           ); ?>" aria-describedby="bingVerify"
                                           value="<?php echo (!empty($options['bing_verify'])) ? esc_html($options['bing_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="bingVerify" class="form-text text-muted">If you havent registered for
                                        Bing Webmaster Verification, Go to <a
                                                href="https://www.bing.com/toolbox/webmaster/">Signup here</a></small>

                                </div>
                                <div class="input-group">
                                    <label for="<?php echo esc_attr('website_verify_options[baidu_verify]'); ?>"><?php _e('Baidu Webmaster Verification'); ?></label>
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[baidu_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[baidu_verify]'
                                           ); ?>" aria-describedby="baiduVerify"
                                           value="<?php echo (!empty($options['baidu_verify'])) ? esc_html($options['baidu_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="baiduVerify" class="form-text text-muted">If you havent registered for
                                        Baidu Webmaster Verification, Go to <a
                                                href="https://passport.baidu.com/v2/?reg">Signup here</a></small>

                                </div>
                                <div class="input-group">
                                    <label for="<?php echo esc_attr('website_verify_options[yandex_verify]'); ?>"><?php _e('Yandex Webmaster Verification'); ?></label>
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[yandex_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[yandex_verify]'
                                           ); ?>" aria-describedby="yandexVerify"
                                           value="<?php echo (!empty($options['yandex_verify'])) ? esc_html($options['yandex_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="yandexVerify" class="form-text text-muted">If you havent registered for
                                        Yandex Webmaster Verification, Go to <a
                                                href="https://passport.yandex.com/registration?origin=webmaster">Signup
                                            here</a></small>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[norton_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[norton_verify]'
                                           ); ?>" aria-describedby="nortonVerify"
                                           value="<?php echo (!empty($options['norton_verify'])) ? esc_html($options['norton_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="nortonVerify" class="form-text text-muted">If you havent registered for
                                        Norton Webmaster Verification, <a href="https://safeweb.norton.com/saml/login">Signup
                                            here</a></small>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                           id="<?php echo esc_attr('website_verify_options[pinterest_verify]'); ?>"
                                           name="<?php echo esc_attr(
                                               'website_verify_options[pinterest_verify]'
                                           ); ?>" aria-describedby="pinterestVerify"
                                           value="<?php echo (!empty($options['pinterest_verify'])) ? esc_html($options['pinterest_verify']) : ''; ?>"
                                           placeholder="Enter only id"/>


                                    <small id="pinterestVerify" class="form-text text-muted">If you havent registered
                                        for Pinterest Webmaster Verification, <a
                                                href="http://pinterest.com/business/create/">Signup here</a></small>
                            ...
                            <div class="column p1">
                                ...
                                <div class="input-group">
                                    <label for="<?php echo esc_attr('website_verify_options[google_verify]'); ?>">Scripts
                                        for traffic & Statistic </label>
                                    <textarea class="form-control"
                                              id="<?php echo esc_attr('website_verify_options[analytics_code]'); ?>"
                                              name="<?php echo esc_attr(
                                                  'website_verify_options[analytics_code]'
                                              ); ?>" cols="10"
                                              rows="15"><?php echo (!empty($options['analytics_code'])) ? esc_html($options['analytics_code']) : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
